...
1. Close the game
2. Download `FixCoreModule.exe` from the [FixCoreModule repo](https://github.com/V1ndicate1/FixCoreModule/releases/latest)
3. Place it in your `Data Center` game folder and run it
...
The manual zip contains pre-generated MelonLoader assemblies that skip the broken generation step. These assemblies are output from [MelonLoader](https://github.com/LavaGang/MelonLoader) (Apache 2.0) and [Il2CppInterop](https://github.com/BepInEx/Il2CppInterop) (LGPL-3.0) — no game code or DCIM code is included. This fix is locked to game version 1.0.47.2.
